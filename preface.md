...
Go語言由來自Google公司的Robert Griesemer，Rob Pike和Ken Thompson於2007年9月開始設計和實現，
...
Go語言的貢獻者來自一個活躍的全球社區。Go語言可以運行在類UNIX繫統之上，
比如Linux、FreeBSD、OpenBSD、Mac OSX、Plan9，還有Microsoft Windows操作繫統。
